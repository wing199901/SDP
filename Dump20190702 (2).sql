...
INSERT INTO `control` VALUES ('Admin',90,''),('Correct ROL',80,''),('Edit Stock',50,''),('Generate Report',70,''),('New Order',10,''),('Receive Goods',60,''),('Report Defective',30,''),('Search Order',20,''),('Search Stock',40,'');
...
INSERT INTO `controlRole` VALUES (1,'Correct ROL',80,0),(1,'Edit Stock',50,0),(1,'Generate Report',70,0),(1,'New Order',10,0),(1,'Receive Goods',60,0),(1,'Report Defective',30,0),(1,'Search Order',20,0),(1,'Search Stock',40,0),(2,'Correct ROL',80,1),(2,'Edit Stock',50,1),(2,'Generate Report',70,1),(2,'New Order',10,1),(2,'Receive Goods',60,1),(2,'Report Defective',30,1),(2,'Search Order',20,0),(2,'Search Stock',40,0),(3,'Correct ROL',80,1),(3,'Edit Stock',50,1),(3,'Generate Report',70,0),(3,'New Order',10,0),(3,'Receive Goods',60,1),(3,'Report Defective',30,1),(3,'Search Order',20,0),(3,'Search Stock',40,0);
...
INSERT INTO `order` VALUES (100001,100001,100001,'Finish','2019-06-05 12:12:12','2019-06-09','LWL','2000',NULL),(100002,100001,100001,'Creation','2019-06-06 12:45:32','2019-07-12','LWL','50400',NULL),(100003,100002,100002,'Creation','2019-06-11 12:43:23','2019-06-15','LWL','3000','Please quickly'),(100004,100001,100003,'Creation','2019-06-14 05:00:47','2019-06-15','l','40','Remark'),(100005,100001,100004,'Creation','2019-06-14 05:04:52','2019-06-15','a','40','Remark'),(100006,100001,100005,'Creation','2019-06-14 05:08:56','2019-06-15','b','480','Remark'),(100007,100001,100006,'Creation','2019-06-14 05:11:16','2019-06-25','c','40','Remark'),(100008,100001,100006,'Creation','2019-06-14 05:15:22','2019-06-19','c','40','Remark'),(100009,100001,100007,'Creation','2019-06-14 05:16:55','2019-06-15','d','40','Remark'),(100010,100001,100008,'Creation','2019-06-14 05:17:44','2019-06-26','e','40','Remark'),(100011,100001,100009,'Creation','2019-06-14 05:21:11','2019-06-15','f','480','Remark'),(100012,100001,100010,'Creation','2019-06-14 05:24:17','2019-06-15','g','40','Remark'),(100013,100001,100011,'Creation','2019-06-14 05:26:22','2019-06-15','h','50','Remark'),(100014,100001,100012,'Creation','2019-06-14 05:27:36','2019-06-15','i','40','Remark'),(100015,100001,100013,'Creation','2019-06-14 05:40:03','2019-06-15','j','5000','Remark'),(100016,100001,100014,'Creation','2019-06-14 05:45:53','2019-06-19','k','40','Remark'),(100017,100001,100015,'Creation','2019-06-14 05:47:38','2019-06-26','q','40','Remark'),(100018,100001,100016,'Creation','2019-06-14 05:52:14','2019-06-26','w','40','Remark'),(100019,100001,100017,'Creation','2019-06-14 05:58:21','2019-06-15','qq','40','Remark'),(100020,100001,100018,'Creation','2019-06-14 06:08:33','2019-06-30','ww','40','Remark');
...
CREATE TABLE `orderProduct` (
  ...
  KEY `orderProduct_productId_fk` (`productId`),
...
INSERT INTO `orderProduct` VALUES (100001,100001,50),(100002,100001,10),(100002,100003,10),(100003,100004,100),(100004,100001,1),(100005,100001,1),(100006,100001,12),(100007,100001,1),(100008,100001,1),(100009,100001,1),(100010,100001,1),(100011,100001,12),(100012,100001,1),(100013,100002,1),(100014,100001,1),(100015,100003,1),(100016,100001,1),(100017,100001,1),(100018,100001,1),(100019,100001,1),(100020,100001,1);
...
INSERT INTO `staff` VALUES (100001,'John','123456',1),(100002,'Andy','abcdef',1),(100003,'May','123456',1),(100004,'Joey','123456',1),(100005,'Peter','412431',1),(100006,'Juno','232142',1),(100007,'Ian','adfsnal',1),(100008,'Ivan','weqweq',1),(100009,'Ada','abcdefg',1),(100010,'Alva','12dsasw',1),(100011,'Bonnie','123456',1),(100012,'Ava','123456',1);
...
CREATE TABLE `staffRole` (
  ...
  KEY `staffRole_roleId_fk` (`roleId`),
  CONSTRAINT `staffRole_roleId_fk` FOREIGN KEY (`roleId`) REFERENCES `role` (`roleId`),
  CONSTRAINT `staffRole_staffId_fk` FOREIGN KEY (`staffId`) REFERENCES `staff` (`staffId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `staffRole` VALUES (100001,1),(100008,1),(100002,2),(100009,2),(100003,3),(100010,3),(100004,4),(100011,4),(100005,5),(100006,5),(100006,6),(100007,7);
...
-- Dump completed on 2019-07-02 15:26:13
