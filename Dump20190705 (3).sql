...
INSERT INTO `control` VALUES ('Correct ROL',900,'all'),('Customer Management',1100,'all'),('Edit Order',210,'all'),('Edit Order',211,'Input actual quantity despatched'),('Edit Order',212,'Update Order Status'),('Edit Stock',510,'all'),('Generate Report',800,'all'),('New Order',100,'all'),('New Purchase Order',600,'all'),('New Stock',400,'all'),('Receive Goods',700,'all'),('Report Defective',300,'all'),('Role Control',1200,'all'),('Search Order',200,'all'),('Search Order',201,'Generater DIS'),('Search Order',202,'Generater Invoice '),('Search Stock',500,'all'),('Staff Management',1000,'all');
...
INSERT INTO `controlRole` VALUES (1,'Correct ROL',900,0),(1,'Customer Management',1100,0),(1,'Edit Order',210,0),(1,'Edit Order',211,0),(1,'Edit Order',212,0),(1,'Edit Stock',510,0),(1,'Generate Report',800,0),(1,'New Order',100,0),(1,'New Purchase Order',600,0),(1,'New Stock',400,0),(1,'Receive Goods',700,0),(1,'Report Defective',300,0),(1,'Role Control',1200,0),(1,'Search Order',200,0),(1,'Search Order',201,0),(1,'Search Order',202,0),(1,'Search Stock',500,0),(1,'Staff Management',1000,0),(2,'Correct ROL',900,1),(2,'Customer Management',1100,1),(2,'Edit Order',210,1),(2,'Edit Order',211,1),(2,'Edit Order',212,1),(2,'Edit Stock',510,1),(2,'Generate Report',800,0),(2,'New Order',100,1),(2,'New Purchase Order',600,1),(2,'New Stock',400,1),(2,'Receive Goods',700,1),(2,'Report Defective',300,1),(2,'Role Control',1200,1),(2,'Search Order',200,0),(2,'Search Order',201,1),(2,'Search Order',202,1),(2,'Search Stock',500,0),(2,'Staff Management',1000,1),(3,'Correct ROL',900,1),(3,'Customer Management',1100,1),(3,'Edit Order',210,0),(3,'Edit Order',211,0),(3,'Edit Order',212,0),(3,'Edit Stock',510,1),(3,'Generate Report',800,0),(3,'New Order',100,0),(3,'New Purchase Order',600,1),(3,'New Stock',400,1),(3,'Receive Goods',700,1),(3,'Report Defective',300,1),(3,'Role Control',1200,1),(3,'Search Order',200,0),(3,'Search Order',201,1),(3,'Search Order',202,0),(3,'Search Stock',500,0),(3,'Staff Management',1000,1),(4,'Correct ROL',900,1),(4,'Customer Management',1100,1),(4,'Edit Order',210,0),(4,'Edit Order',211,0),(4,'Edit Order',212,1),(4,'Edit Stock',510,1),(4,'Generate Report',800,0),(4,'New Order',100,1),(4,'New Purchase Order',600,1),(4,'New Stock',400,1),(4,'Receive Goods',700,0),(4,'Report Defective',300,0),(4,'Role Control',1200,1),(4,'Search Order',200,0),(4,'Search Order',201,0),(4,'Search Order',202,1),(4,'Search Stock',500,1),(4,'Staff Management',1000,1),(5,'Correct ROL',900,1),(5,'Customer Management',1100,1),(5,'Edit Order',210,1),(5,'Edit Order',211,1),(5,'Edit Order',212,1),(5,'Edit Stock',510,0),(5,'Generate Report',800,0),(5,'New Order',100,1),(5,'New Purchase Order',600,0),(5,'New Stock',400,0),(5,'Receive Goods',700,1),(5,'Report Defective',300,1),(5,'Role Control',1200,1),(5,'Search Order',200,1),(5,'Search Order',201,1),(5,'Search Order',202,1),(5,'Search Stock',500,0),(5,'Staff Management',1000,1),(6,'Correct ROL',900,0),(6,'Customer Management',1100,1),(6,'Edit Order',210,0),(6,'Edit Order',211,1),(6,'Edit Order',212,0),(6,'Edit Stock',510,1),(6,'Generate Report',800,0),(6,'New Order',100,0),(6,'New Purchase Order',600,0),(6,'New Stock',400,0),(6,'Receive Goods',700,1),(6,'Report Defective',300,1),(6,'Role Control',1200,1),(6,'Search Order',200,0),(6,'Search Order',201,1),(6,'Search Order',202,0),(6,'Search Stock',500,0),(6,'Staff Management',1000,1),(7,'Correct ROL',900,1),(7,'Customer Management',1100,1),(7,'Edit Order',210,0),(7,'Edit Order',211,1),(7,'Edit Order',212,0),(7,'Edit Stock',510,1),(7,'Generate Report',800,1),(7,'New Order',100,1),(7,'New Purchase Order',600,1),(7,'New Stock',400,1),(7,'Receive Goods',700,1),(7,'Report Defective',300,1),(7,'Role Control',1200,1),(7,'Search Order',200,0),(7,'Search Order',201,1),(7,'Search Order',202,0),(7,'Search Stock',500,1),(7,'Staff Management',1000,1);
...
CREATE TABLE `product` (
  ...
  `description` varchar(45) NOT NULL,
  `atHand` int(11) NOT NULL DEFAULT '0',
  `onHand` int(11) NOT NULL DEFAULT '0',
  `inHand` int(11) NOT NULL DEFAULT '0',
  `price` double NOT NULL,
  `leadTime` int(3) NOT NULL DEFAULT '7',
...
INSERT INTO `product` VALUES (100001,'A','Self','Metal03','The metal 03',0,1000,1000,40,7,0,0),(100002,'A','Self','Metal01','The first metal',0,1000,1000,50,7,0,0),(100003,'B','Self','Engine01','The major engine',0,1000,1000,5000,7,0,0),(100004,'C','Self','Bulb01','The smail bulb',0,1000,1000,30,7,0,0),(100005,'D','Self','Metal Button 01','The smaill metal button',0,1000,1000,5,7,0,0),(100006,'A','Self','Metal02','The metal 02',0,1000,1000,30,7,0,0);
...
CREATE TABLE `staff` (
  ...
  `pwd` varchar(50) NOT NULL DEFAULT '000000',
...
-- Dump completed on 2019-07-05  8:09:21
